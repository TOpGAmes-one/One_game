namespace SpriteKind {
    export const moedinha = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.moedinha, function (sprite, otherSprite) {
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    tiles.setTileAt(one_player.tilemapLocation().getNeighboringLocation(CollisionDirection.Bottom), sprites.skillmap.islandTile7)
    tiles.setWallAt(one_player.tilemapLocation().getNeighboringLocation(CollisionDirection.Bottom), true)
})
...
function gerar_mapas () {
    ...
    tiles.placeOnRandomTile(one_player, assets.tile`myTile3`)
    for (let objeto1 of tiles.getTilesByType(assets.tile`myTile3`)) {
        tiles.setTileAt(objeto1, assets.tile`transparency16`)
    }
    scene.cameraFollowSprite(one_player)
    info.setLife(3)
    for (let object2 of tiles.getTilesByType(assets.tile`myTile1`)) {
        inimigo = sprites.create(img`
            ...
            . . . . . 7 7 . 7 7 . . . . . . 
            `, SpriteKind.Enemy)
        tiles.placeOnTile(inimigo, object2)
        tiles.setTileAt(object2, assets.tile`transparency16`)
    }
    for (let object3 of tiles.getTilesByType(assets.tile`myTile2`)) {
        moeda = sprites.create(img`
            ...
            . . f f f f . . 
            `, SpriteKind.moedinha)
        tiles.placeOnTile(moeda, object3)
        tiles.setTileAt(object3, assets.tile`transparency16`)
...
scene.onOverlapTile(SpriteKind.Projectile, sprites.skillmap.islandTile7, function (sprite, location) {
    tiles.setTileAt(location, assets.tile`transparency16`)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    otherSprite.startEffect(effects.warmRadial, 2000)
    otherSprite.setPosition(otherSprite.x - 50, otherSprite.y)
})
...
one_player = sprites.create(img`
    ...
    . . . c c c c c c c c b b . . . 
    `, SpriteKind.Player)
controller.moveSprite(one_player, 100, 0)
gerar_mapas()
bolsa_guarda = 0
game.onUpdate(function () {
    if (one_player.vy < 0) {
        one_player.setImage(img`
            . . . . . . . . . b 5 b . . . . 
            . . . . . . . . . b 5 b . . . . 
            . . . . . . b b b b b b . . . . 
            . . . . . b b 5 5 5 5 5 b . . . 
    ...
    if ((one_player.isHittingTile(CollisionDirection.Right) || one_player.isHittingTile(CollisionDirection.Left)) && one_player.vy == 0) {
        one_player.ay = 0
        one_player.vy = 0
        one_player.setImage(img`
            . . . . . . . . . . b 5 b . . . 
