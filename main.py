@namespace
class SpriteKind:
    moedinha = SpriteKind.create()

def on_on_overlap(sprite, otherSprite):
    sprites.destroy(otherSprite, effects.rings, 500)
    info.change_score_by(1)
sprites.on_overlap(SpriteKind.player, SpriteKind.moedinha, on_on_overlap)
...
# def palavra chave que inicia função
# ponto significa açesso
def gerar_mapas():
    global inimigo, moeda
    if level_atual == 0:
        ...
        game.game_over(True)
    tiles.place_on_random_tile(one_player, assets.tile("""
        myTile3
        """))
    for objeto1 in tiles.get_tiles_by_type(assets.tile("""
        myTile3
        """)):
        tiles.set_tile_at(objeto1, assets.tile("""
            transparency16
            """))
    scene.camera_follow_sprite(one_player)
    info.set_life(3)
    for object2 in tiles.get_tiles_by_type(assets.tile("""
        myTile1
        """)):
        inimigo = sprites.create(img("""
                ...
                """),
            SpriteKind.enemy)
        tiles.place_on_tile(inimigo, object2)
        tiles.set_tile_at(object2, assets.tile("""
            transparency16
            """))
    for object3 in tiles.get_tiles_by_type(assets.tile("""
        myTile2
        """)):
        moeda = sprites.create(img("""
                ...
                """),
            SpriteKind.moedinha)
        tiles.place_on_tile(moeda, object3)
        tiles.set_tile_at(object3, assets.tile("""
            transparency16
            """))
        animation.run_image_animation(moeda,
            [img("""
                    . . b b b b . .
                    . b 5 5 5 5 b .
                    b 5 d 3 3 d 5 b
...
def on_on_overlap2(sprite6, otherSprite2):
    ...
    otherSprite2.start_effect(effects.warm_radial, 2000)
    otherSprite2.set_position(otherSprite2.x - 50, otherSprite2.y)
sprites.on_overlap(SpriteKind.player, SpriteKind.enemy, on_on_overlap2)

moeda: Sprite = None
inimigo: Sprite = None
bolsa_guarda = 0
one_player: Sprite = None
level_atual = 0
level_atual = 0
...
one_player = sprites.create(img("""
        ...
        """),
    SpriteKind.player)
controller.move_sprite(one_player, 100, 0)
gerar_mapas()
bolsa_guarda = 0

def on_on_update():
    if one_player.vy < 0:
        one_player.set_image(img("""
            . . . . . . . . . b 5 b . . . .
            . . . . . . . . . b 5 b . . . .
            . . . . . . b b b b b b . . . .
            . . . . . b b 5 5 5 5 5 b . . .
        ...
        one_player.set_image(img("""
            ...
            . . . c c c c c c c c b b . . .
            """))
    if (one_player.is_hitting_tile(CollisionDirection.RIGHT) or one_player.is_hitting_tile(CollisionDirection.LEFT)) and one_player.vy == 0:
        one_player.ay = 0
        one_player.vy = 0
        one_player.set_image(img("""
            . . . . . . . . . . b 5 b . . .
